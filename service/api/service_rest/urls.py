...
from .views import api_list_technicians, api_show_technicians, api_list_appointment, api_show_service, api_list_automobiles
...
urlpatterns = [
    ...
    path("automobiles/", api_list_automobiles, name="list_automobiles"),
]
