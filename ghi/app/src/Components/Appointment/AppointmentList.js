                  ...
                  <div className="offset-3 col-6">
                      <div className="shadow p-4 mt-4">
                          ...
                          <form onSubmit={handleSubmit}>
                              ...
                              <div className='form-floating mb-3'>
                                  <input onChange={handleDateTimeChange} value={date_time} placeholder='date_time' required type="datetime-local" name="date_time" id="date_time" className='form-control text-sm'/>
                                  <label htmlFor="date_time">Schedule Date & Time for Appointment</label>
                              </div>
                              <div className='form-floating mb-3'>
