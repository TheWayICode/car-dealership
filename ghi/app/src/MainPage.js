import Supra1 from "./assets/supra2.jpg";

function MainPage() {
  return (
    <div className="min-h-screen overflow-hidden">
      <div
        className="bg-center bg-cover bg-no-repeat w-full transition-all"
        style={{
        ...
        <div className="min-h-screen text-center pt-72 text-white bg-black bg-opacity-50">
          ...
          <p className="text-lg font-semibold pb-4"><i>The premiere solution for automobile dealership management</i></p>
        </div>
        <div className="text-center py-20 text-gray-100 bg-gray-800 bg-opacity-90">
          ...
          <p className="text-base font-semibold"><i>"To provide our customers with the best car buying experience possible"</i></p>
        </div>
